...
function AnswersRadio({
    ...
    function controle(event) {
        ...
        // FIXME : je pense qu'on pourrait alléger la logique de vérification des réponses
        ...
        <div className='answersRadio'>
            ...
            <form className="reponse" id="formCheck" type='submit' method='get' action='/'
                ...
                <div className="containerButtonValidate">
                    <button id="buttonHandleValidateID" className="buttonHandleValidate"
                            onClick={(event) => controle(event)}>Validate
                    </button>
                </div>
            </form>
        </div>);
