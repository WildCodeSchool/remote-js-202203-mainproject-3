...
function App() {
    ...
    const getQuizz = () => {
        ...
        // FIXED : En react, j'évite de manipuler le DOM à la main
    ...
    return (
        <div className="App">
            ...
            {/* FIXED Au lieu de manipuler le DOM à la main, je me base sur l'état */}
            {quizzList.length === 0 ?
                <button className="quizzButton" onClick={getQuizz} id='buttonBegin'>Commencer le Quizz</button> : null}
